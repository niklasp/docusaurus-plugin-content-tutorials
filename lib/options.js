...
const VersionOptionsSchema = utils_validation_1.Joi.object({
  ...
  banner: utils_validation_1.Joi.string()
    .equal("none", "unreleased", "unmaintained")
    .optional(),
...
const OptionsSchema = utils_validation_1.Joi.object({
  ...
  editUrl: utils_validation_1.Joi.alternatives().try(
    utils_validation_1.URISchema,
    utils_validation_1.Joi.function()
  ),
  editCurrentVersion: utils_validation_1.Joi.boolean().default(
    exports.DEFAULT_OPTIONS.editCurrentVersion
  ),
  editLocalizedFiles: utils_validation_1.Joi.boolean().default(
    exports.DEFAULT_OPTIONS.editLocalizedFiles
  ),
  routeBasePath: utils_validation_1.Joi.string()
    // '' not allowed, see https://github.com/facebook/docusaurus/issues/3374
    // .allow('') ""
    .default(exports.DEFAULT_OPTIONS.routeBasePath),
  tagsBasePath: utils_validation_1.Joi.string().default(
    exports.DEFAULT_OPTIONS.tagsBasePath
  ),
  ...
  include: utils_validation_1.Joi.array()
    .items(utils_validation_1.Joi.string())
    .default(exports.DEFAULT_OPTIONS.include),
  exclude: utils_validation_1.Joi.array()
    .items(utils_validation_1.Joi.string())
    .default(exports.DEFAULT_OPTIONS.exclude),
  sidebarPath: utils_validation_1.Joi.alternatives().try(
    utils_validation_1.Joi.boolean().invalid(true),
    utils_validation_1.Joi.string()
  ),
  sidebarItemsGenerator: utils_validation_1.Joi.function().default(
    () => exports.DEFAULT_OPTIONS.sidebarItemsGenerator
  ),
  ...
  numberPrefixParser: utils_validation_1.Joi.alternatives()
    .try(
      ...
      utils_validation_1.Joi.alternatives().conditional(
        ...
        {
          then: utils_validation_1.Joi.custom((val) =>
            val
              ? numberPrefix_1.DefaultNumberPrefixParser
              : numberPrefix_1.DisabledNumberPrefixParser
          ),
        }
      )
    )
    .default(() => exports.DEFAULT_OPTIONS.numberPrefixParser),
  docLayoutComponent: utils_validation_1.Joi.string().default(
    exports.DEFAULT_OPTIONS.docLayoutComponent
  ),
  docItemComponent: utils_validation_1.Joi.string().default(
    exports.DEFAULT_OPTIONS.docItemComponent
  ),
  docTagsListComponent: utils_validation_1.Joi.string().default(
    exports.DEFAULT_OPTIONS.docTagsListComponent
  ),
  docTagDocListComponent: utils_validation_1.Joi.string().default(
    exports.DEFAULT_OPTIONS.docTagDocListComponent
  ),
  docCategoryGeneratedIndexComponent: utils_validation_1.Joi.string().default(
    exports.DEFAULT_OPTIONS.docCategoryGeneratedIndexComponent
  ),
  ...
  admonitions: utils_validation_1.AdmonitionsSchema.default(
    exports.DEFAULT_OPTIONS.admonitions
  ),
  showLastUpdateTime: utils_validation_1.Joi.bool().default(
    exports.DEFAULT_OPTIONS.showLastUpdateTime
  ),
  showLastUpdateAuthor: utils_validation_1.Joi.bool().default(
    exports.DEFAULT_OPTIONS.showLastUpdateAuthor
  ),
  includeCurrentVersion: utils_validation_1.Joi.bool().default(
    exports.DEFAULT_OPTIONS.includeCurrentVersion
  ),
  onlyIncludeVersions: utils_validation_1.Joi.array()
    .items(utils_validation_1.Joi.string().required())
    .optional(),
  disableVersioning: utils_validation_1.Joi.bool().default(
    exports.DEFAULT_OPTIONS.disableVersioning
  ),
  lastVersion: utils_validation_1.Joi.string().optional(),
  versions: VersionsOptionsSchema,
  breadcrumbs: utils_validation_1.Joi.bool().default(
    exports.DEFAULT_OPTIONS.breadcrumbs
  ),
});
function validateOptions({ validate, options: userOptions }) {
  ...
  if (options.sidebarCollapsible === false) {
    ...
    if (options.sidebarCollapsed) {
      logger_1.default
        .warn`The docs plugin config is inconsistent. It does not make sense to use code=${"sidebarCollapsible: false"} and code=${"sidebarCollapsed: true"} at the same time. code=${"sidebarCollapsed: true"} will be ignored.`;
      options = {
        ...options,
        sidebarCollapsed: false,
      };
