 ...
 */
import { MetadataOptions, PluginOptions, CategoryIndexMatcher, DocMetadataBase, VersionMetadata, LoadedVersion } from '@niklasp/plugin-content-tutorials';
...
export declare function addDocNavigation(docsBase: DocMetadataBase[], sidebarsUtils: SidebarsUtils, sidebarFilePath: string): LoadedVersion['tutorials'];
/**
 ...
 */
export declare function getMainDocId({ tutorials, sidebarsUtils, }: {
