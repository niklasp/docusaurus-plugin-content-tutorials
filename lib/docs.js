...
async function doProcessDocMetadata({ docFile, versionMetadata, context, options, env, }) {
    ...
    const frontMatter = (0, frontMatter_1.validateTutorialFrontMatter)(unsafeFrontMatter);
 ...
 */
function getMainDocId({ tutorials, sidebarsUtils, }) {
    function getMainDoc() {
        ...
        if (versionHomeDoc) {
            ...
            return tutorials.find((doc) => doc.id === firstDocIdOfFirstSidebar ||
