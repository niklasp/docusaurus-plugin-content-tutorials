...
export const useAllDocsData = () => useAllPluginInstancesData('docusaurus-plugin-content-tutorials') ?? StableEmptyObject;
export const useDocsData = (pluginId) => usePluginData('docusaurus-plugin-content-tutorials', pluginId, {
    failfast: true,
});
