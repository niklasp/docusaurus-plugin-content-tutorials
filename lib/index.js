...
async function pluginContentTutorials(context, options) {
    ...
    return {
        ...
        async loadContent() {
            ...
            async function doLoadVersion(versionMetadata) {
                ...
                const [drafts, tutorials] = lodash_1.default.partition(docsBase, (tutorial) => tutorial.draft);
                ...
                return {
                    ...versionMetadata,
                    tutorials: (0, docs_1.addDocNavigation)(tutorials, sidebarsUtils, versionMetadata.sidebarFilePath),
                    drafts,
                    sidebars,
                };
            }
        ...
        async contentLoaded({ content, actions }) {
            ...
            async function createVersionTagsRoutes(version) {
                const versionTags = (0, tags_1.getVersionTags)(version.tutorials);
            ...
            if (versions[0] !== undefined) {
                versionTags = (0, tags_1.getTaggedTutorials)(versions[0].tutorials);
            }
            setGlobalData({
...
exports.default = pluginContentTutorials;
